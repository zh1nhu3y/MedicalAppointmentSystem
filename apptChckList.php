...
<head>
    ...
    <title>Appointment Checklist</title>
...
<body>
    ...
    <div class="title">
        ...
        <div class="word">
            ...
            <h4><i>Home > Patient Care > Appointment Checklist</i></h4>
        </div>
    </div>
    <section>
        <div class="patient-info">
            <div class="info">
                <h1>The things you need to bring</h1>
                <h3>What to bring?</h3>
                <p><b>Here is a list that will assist you in getting ready for your doctor's appointment. </b><br></p>
                <ol>
                    <li>Gather all the paperwork you need to bring to the doctor's appointment such as copies of any examinations, x-rays, or medical records pertaining to your health issue, a completed the medical history form, a list of all current prescription, over-the-counter, and herbal medications that are regularly taken.</li><br>
                    <li>Prior to your consultation, review any special instructions from your doctor regarding dietary or drug restrictions.</li><br>
                    <li>If you like, arrange for a friend or family member to go with you. You could require a ride home, depending on the kind of appointment you have.</li><br>
                </ol>
            
                <h3>During the Appointment</h3>
                <p>
                    Make a list of questions, and don't forget to discuss your worries with your doctor. 
                </p>
                <h3>After the Appointment</h3>
                <ol>
                    <li>We will try our best to organise additional tests and consultations at the earliest opportunity if you need to see another doctor.</li><br>
                    <li>If you need to be hospitalised, we will set up your admission plans and give the hospital the necessary details before you go.</li><br>
                </ol>
            </div>
        </div>
    </section>
