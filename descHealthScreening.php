...
<body>
    ...
    <div class="title">
        ...
        <div class="word">
            ...
            <h4><i>Home > Our Services > Health Screening</i></h4>
        </div>
    </div>
    <section>
        <div class="service-info">
            <div class="info">
                <h1>Health Screening</h1>
                <h4>Health screening services in our clinic for the elderly are designed to identify and address health concerns before they become more serious. Health screening services are vital for maintaining older individuals' health and well-being because they can help spot any health problems early, when they are easier to treat. These services may include:</h4>
                <ul>
                    <li><b>Physical exams:</b> Comprehensive physical exams to assess overall health and identify any potential health problems.</li><br>
                    <li><b>Vital sign monitoring:</b> Monitoring of vital signs such as blood pressure, heart rate, and body temperature to track overall health and identify potential problems.</li><br>
                    <li><b>Screening for chronic conditions:</b> Screening tests to detect and monitor chronic conditions such as heart disease, cancer, and osteoporosis.</li><br>
                    <li><b>Cognitive assessments:</b> Cognitive assessments to screen for conditions such as Alzheimer's disease and dementia.</li><br>
                    <li><b>Vital sign monitoring:</b> Monitoring of vital signs such as blood pressure, heart rate, and body temperature to track overall health and identify potential problems.</li><br>
                </ul>
            </div>
